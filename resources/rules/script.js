...
function initializeFAQ() {
    let questions = document.getElementById("info").getElementsByClassName("question")
    let answers = document.getElementById("info").getElementsByClassName("answer")
    for (let i = 0; i < questions.length; i++) {
        questions[i].onclick = function () {
            ...
            if (answers[i].style.display === "block") {
                ...
                questions[i].getElementsByTagName("img")[0].style.transform = "rotate(90deg)"
