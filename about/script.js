...
function changeScreenSizeMain(width, height) {
    ...
    if (width < 1200) {
        let navigationButtons = document.getElementsByClassName("aboutNavigationLink")
        for (let i = 0; i < navigationButtons.length; i++) {
            navigationButtons[i].style.width = "70%"
        }
        document.getElementById("quote").getElementsByTagName("section")[0].style.flexDirection = "column"
    }
    else {
        let navigationButtons = document.getElementsByClassName("aboutNavigationLink")
        for (let i = 0; i < navigationButtons.length; i++) {
        ...
        document.getElementById("quote").getElementsByTagName("section")[0].style.flexDirection = "row"
    }
}