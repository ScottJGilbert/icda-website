...
function changeScreenSizeMain(width) {
    changeSection(document.getElementById("billWriting").getElementsByTagName("section")[0],width)
    changeSection(document.getElementById("speeches").getElementsByTagName("section")[0],width)
    if (width < 550) {
